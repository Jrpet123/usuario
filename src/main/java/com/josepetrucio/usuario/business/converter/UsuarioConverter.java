package com.josepetrucio.usuario.business.converter;
...
public class UsuarioConverter {
    ...
    public Endereco updateEndereco(EnderecoDTO dto, Endereco entity){
        ...
        return Endereco.builder()
                ...
                .cep(dto.getCep() != null? dto.getCep(): entity.getCidade())
    ...
    public Telefone paraTelefoneEntity(TelefoneDTO dto, Long idUsuario){
        ...
        //não é necessario passar o id do telefone, pq ele gerado automaticamente quandoa grava no banco de dados
    }
...
/* sem @Component ficaria assim:
* public Usuario paraUsuario(UsuarioDTO){
